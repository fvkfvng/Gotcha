<?php
    ...
    if(isset($_SESSION['uline_user']) && $_SESSION['uline_user']!=""){
    ...
    if(isset($_SESSION['uline_refresh_token']) && $_SESSION['uline_refresh_token']!=""){
        echo '
        <form method="post">
    ...
    if (isset($_POST['lineLogout'])) {
        unset(
            $_SESSION['uline_token'],
            $_SESSION['uline_refresh_token'],
            $_SESSION['uline_user']
        );  
        echo "<hr>";
